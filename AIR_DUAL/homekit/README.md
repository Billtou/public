...
💡 跟 Matter 產品不同,<b>HomeKit 是 Apple 專屬生態</b>,只能接入 Apple Home(iPhone / iPad / Mac)。如需 Google Home / Home Assistant / Alexa 跨生態,請選 Matter 版產品。
</blockquote>
...
<h2 style="color:#1c3d5a;border-bottom:3px solid #ff6f48;padding-bottom:8px;margin-top:48px;font-size:28px">7. 模式與功能</h2>

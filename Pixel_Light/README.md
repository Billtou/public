...
有買國外小哥的藍圖，但藍圖選單上無法找到像素燈實體的朋友請注意，因為像素燈新版0.96把廠牌改成AWTRIX 3，但藍圖是基於0.94版建立的，在國外小哥還沒因應 0.96 update前，建議降級到0.94版，上面有old_awtrix2_conversion_0.94.bin檔案，下載後網頁進入像素燈IP，選file > Firmware: 指定檔案 > 再點 Update Firmware 即可。

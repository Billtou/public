...
| **Home Assistant** | `light.tuyafan_xxxxxx` → toggle |
...
<td>配對完成 → 出現「<b>TuyaFan-XXXXXX</b>」(可在 App 內改名),包含**風扇**與**面板指示燈**兩個 icon</td></tr></table>
</td></tr>
</table>
...
4. App 自動完成,出現 `fan.tuyafan_xxxxxx` + `light.tuyafan_xxxxxx`(後者控制面板指示燈,可在前端改名)

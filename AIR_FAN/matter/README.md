...
<p style="margin:6px 0 0;font-size:14px;color:#5a6a7a">遙控器走原 RF/IR 通路,跟 Matter 並行</p>
</td></tr>
<tr><td style="background:#fff;padding:18px;border-radius:14px;border:1px solid #e5e7eb;box-shadow:0 2px 8px rgba(0,0,0,0.04)">
<p style="margin:0;font-weight:700;color:#1c3d5a">🌪️ 原 7 段風速</p>
<p style="margin:6px 0 0;font-size:14px;color:#5a6a7a">全部可用,Matter 對映 1–100 % 滑桿</p>
</td>
...
<td>配對完成 → 出現「<b>TuyaFan-XXXXXX</b>」(可在 App 內改名),以<b>風扇 icon</b> 顯示</td></tr></table>
</td></tr>
</table>
...
<tr><td style="padding:10px 16px;border-top:1px solid #eef1f6">OEM 品牌名 / Logo / 說明連結</td><td align="center" style="padding:10px 16px;border-top:1px solid #eef1f6;color:#27ae60">❌ 保留</td></tr>
...
<p style="margin:0;font-size:14px"><b style="color:#1c3d5a">AUTOMATE</b> · AirFan · 韌體 v0.1.0</p>

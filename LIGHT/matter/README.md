...
<p align="center" style="margin:-24px 0 32px;font-size:12px;color:#5a6a7a">
  ⬆️ 產品介紹 · 重置進入連網模式 · HA → Apple Home · Apple Home → HA · Web UI 調整參數說明 ⬆️
</p>
...
- **AC 開關控制線輸入(S1 / S2)**:可選接機械式開關控制線,觸發電燈開/關
- **內建 Wi-Fi 天線**:無需外接
...
預設**通電後燈具開啟**(便於斷電後復電仍可使用)。可在 Web UI 首頁「**計時器與連動設定**」卡片改為:
...
1. 通電 LT,等裝置完成上電(LED 燈具會一秒閃爍一下進入配對模式)
...
- 接線前**先斷電**,確認電壓符合機型(110V)
- 燈具 LED 輸出側勿短路或反接(共陽極正極為 +24V / +36V)

...
### 二代毫米波感應器已經升級為LD2412，增加了自動背景偵測的功能，現場在沒有wifi環境下可以先將感測器固定好，橋好角度按一下面板前的小洞會開始倒數10秒(人遠離淨空現場)，第一次短絀音結束後開始偵測背景， 約莫1分鐘當第二次短絀音出現後就偵測完成了，毫米坡會重新開機稍待就能精準偵測了。
![Mosquitto_broker](/auto_space/image/004310.png)

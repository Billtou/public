...
## 9.若實際最高水位是200公分，誤輸入成300公分，可能會加到溢出來，敬請準確輸入或輸入比實際要少一些的最高水位高度，觀察實際運作後適時調整。
## 10.偵測水位每5秒鐘1次，反饋水位高度是3次的平均線，例如設定90%滿水實際馬達停止運轉後水位會比90%多一點點，好處是水位反饋不會忽高忽低，以及避免與定時加滿水的判斷條件差異過小產生不必要的加水動作。

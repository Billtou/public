...
<td align="center" style="border:none;padding:0 20px;vertical-align:middle">
  <img src="https://raw.githubusercontent.com/Billtou/public/main/QR_CODE/qr-11188999-AUTM.png" width="160" height="160" alt="HomeKit 配對 QR (X-HM://)" style="border:1px solid #dde3ec;border-radius:12px;background:#fff">
  <p style="margin:8px 0 0;font-size:11px;color:#8a96a3">iPhone 家庭 App 可直接掃描配對</p>
</td>
<td align="left" style="border:none;padding:0 20px;vertical-align:middle">
  ...
  <p style="margin:14px 0 0;font-size:12px;color:#8a96a3;line-height:1.5">左側 QR 為 AUTOMATE 全產品共用配對碼<br>(機身標籤上也有同一張 QR)</p>
</td>
</tr>
</table>
...
<li>iPhone / iPad <b>已設定「家庭」App</b>(iOS 16.1+)</li>
...
| 主燈 / 夜燈 / 韻律風 / 感應換氣 | 主燈開關(其餘僅面板)| `switch`(依機型,四項)|
| 室溫 | 溫度感測器 | `sensor`(溫度)|
...
|---|---|---|
| 風量(開關 + 多段)| 風扇 | `fan` |
| 氣流模式(熱交換 / 旁通 / 自動旁通 / 內循環)| 開關(依機型)| `switch`(旁通 / 自動旁通 / 內循環,依機型)|
